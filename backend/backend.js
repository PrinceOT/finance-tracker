...
//   clientID: functions.config().PLAID_CLIENT_ID,
//   secret: functions.config().PLAID_SECRET,
//   env: plaid.PlaidEnvironments.development,
// });
...
app.get('/api/get_income', function (req, res,next)  {
  Promise.resolve()
  .then(async function () {
